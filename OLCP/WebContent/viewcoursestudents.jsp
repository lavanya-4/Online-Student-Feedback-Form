<%-- 
    ...
    Created on : Feb 7, 2012, 12:38:40 PM
...
int cid=0;
           ...
           String query="select r.Name,r.Email,r.College,r.Department from registration r,stdcourse s where r.Username=s.Username AND s.Courseid="+cid+"";
